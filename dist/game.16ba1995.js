...
class LevelScene2 extends Phaser.Scene {
    ...
    create(gameData) {
        ...
        backgroundMusic = this.sound.add("background2", {
            loop: true
        });
        ...
        for(let i = 0; i < coalNum; i++)this.coalGroup.create(Phaser.Math.Between(0, gameWidth), Phaser.Math.Between(gameHeight - 760, gameHeight), "coal");
        for(let i = 0; i < emeraldNum; i++)this.emeraldGroup.create(Phaser.Math.Between(0, gameWidth), Phaser.Math.Between(gameHeight - 760, gameHeight), "emerald");
        for(let i = 0; i < topazNum; i++)this.topazGroup.create(Phaser.Math.Between(0, gameWidth), Phaser.Math.Between(gameHeight - 760, gameHeight), "topaz");
        for(let i = 0; i < bluestoneNum; i++)this.bluestoneGroup.create(Phaser.Math.Between(0, gameWidth), Phaser.Math.Between(gameHeight - 760, gameHeight), "bluestone");
        for(let i = 0; i < diamondNum; i++)this.diamondGroup.create(Phaser.Math.Between(0, gameWidth), Phaser.Math.Between(gameHeight - 760, gameHeight), "diamond");
        ...
        for(let i = 0; i < stonemonsterNum; i++)this.stonemonsterGroup.create(Phaser.Math.Between(30, gameWidth), Phaser.Math.Between(gameHeight - 760, gameHeight), "stonemonster");
        for(let i = 0; i < smallPlatformNum; i++)this.smallPlatformGroup.create(Phaser.Math.Between(210, gameWidth), Phaser.Math.Between(gameHeight - 760, gameHeight), "mountainsmallPlatform");
        for(let i = 0; i < skeletonPlatformNum; i++)this.skeletonPlatformGroup.create(Phaser.Math.Between(210, gameWidth), Phaser.Math.Between(gameHeight - 760, gameHeight), "mountainsmallSkeletonPlatform");
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["8FDfE","fNmku"], "fNmku", "parcelRequirecd09")
