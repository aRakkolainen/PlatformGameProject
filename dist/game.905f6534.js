...
},{"./src/startScene":"loePq","./src/levelScene1":"4cF2E","./src/levelScene2":"fNmku","./src/levelScene3":"ccm34","./src/finishScene":"5rk9W","./src/styles.css":"lW6qc","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"ccm34":[function(require,module,exports) {
...
class LevelScene3 extends Phaser.Scene {
    ...
    create(gameData) {
        ...
        for(let i = 0; i < platformNum; i++)this.platformGroup.create(Phaser.Math.Between(0, gameWidth), Phaser.Math.Between(gameHeight - 800, gameHeight), "moonplatform");
        for(let i = 0; i < smallPlatformNum; i++)this.smallPlatformGroup.create(Phaser.Math.Between(0, gameWidth), Phaser.Math.Between(gameHeight - 800, gameHeight), "smallmoonPlatform");
        for(let i = 0; i < smallPlatformNum; i++)this.moonplatformGroup.create(Phaser.Math.Between(0, gameWidth), Phaser.Math.Between(gameHeight - 800, gameHeight), "smallmoonPlatform");
        for(let i = 0; i < smallPlatformNum; i++)this.moonplatformGroup.create(Phaser.Math.Between(0, gameWidth), Phaser.Math.Between(gameHeight - 800, gameHeight), "smallmoonPlatform");
        ...
        for(let i = 0; i < starNum; i++)this.starGroup1.create(Phaser.Math.Between(0, gameWidth), Phaser.Math.Between(gameHeight - 800, gameHeight), "star1");
        for(let i = 0; i < starNum2; i++)this.starGroup2.create(Phaser.Math.Between(0, gameWidth), Phaser.Math.Between(gameHeight - 800, gameHeight), "star2");
        for(let i = 0; i < starNum3; i++)this.starGroup3.create(Phaser.Math.Between(0, gameWidth), Phaser.Math.Between(gameHeight - 800, gameHeight), "star3");
        for(let i = 0; i < starNum4; i++)this.starGroup4.create(Phaser.Math.Between(0, gameWidth), Phaser.Math.Between(gameHeight - 800, gameHeight), "star4");
...
},{"./assets/moonplatform.png":"fwrSy","./assets/smallmoon_platform.png":"8LWmS","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fwrSy":[function(require,module,exports) {
