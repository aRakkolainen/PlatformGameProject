...
})({"8hg50":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "677d9325cc62e417";
"use strict";
...
},{}],"loePq":[function(require,module,exports) {
/*Sources: 
...
class StartScene extends Phaser.Scene {
    ...
    create(data) {
        ...
        this.add.text(gameConfig.scale.width / 4, gameConfig.scale.height / 10, "SIMPLE PLATFORM GAME", {
            fontStyle: "bold",
            fontSize: "30px"
        });
        this.add.text(gameConfig.scale.width / 4, gameConfig.scale.height - 8.5, "By aRakkolainen", {
            fontStyle: "bold",
            fontSize: "25px"
        });
        // Source for getting username: https://www.thepolyglotdeveloper.com/2020/09/accept-text-input-user-phaser-game/ 
        this.startText = this.add.text(gameConfig.scale.width / 5, gameConfig.scale.height - 200, "Welcome to play, Press SPACE to start new game", {
            fontStyle: "bold",
            fontSize: "18px"
        });
        ...
        this.returnKey.on("down", (event)=>{
            ...
            if (username.value != "") {
                ...
                username.value = "";
            } else this.startText.setText("Welcome to play, player! Press SPACE to start new game!");
        });
...
},{"./styles.css":"lW6qc","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"lW6qc":[function() {},{}],"gkKU3":[function(require,module,exports) {
...
},{}]},["8hg50","loePq"], "loePq", "parcelRequirecd09")

//# sourceMappingURL=game.cc62e417.js.map
